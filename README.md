...
```bash
pip install git+https://github.com/xiaozhucchongya-byte/amazon-product-scraper.git
```

### From source

```bash
git clone https://github.com/xiaozhucchongya-byte/amazon-product-scraper.git
...
1. **⭐ Star this repository** — [Click here to star](https://github.com/xiaozhucchongya-byte/amazon-product-scraper)
2. **📧 Share with your network** — Help others discover this tool
3. **🐛 Report issues** — [Open an issue](https://github.com/xiaozhucchongya-byte/amazon-product-scraper/issues) if you find a bug
...
[![Star History](https://img.shields.io/github/stars/xiaozhucchongya-byte/amazon-product-scraper?style=social)](https://github.com/xiaozhucchongya-byte/amazon-product-scraper)
